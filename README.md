...
def tambah_data():
    ...
    while ulangi =='y':
        ...
        if ulangi == 't':
            print('\nData Atas Nama',nama, 'Dengan NIM\t',nim, 'Berhasil Ditambahkan!')
            return data
...
Source Code init.py untuk view
```python
from view_nilai import*
```

Source Code input_nilai untuk tambah data di folder view
```python
# Menginput data
def input_nama():
...
Source Code main.py atau kerangka utama program saya letakkan diluar folder view dan model
```python
